import tqdm
import torch
import NVRC.loss_models.RankDVQA.networks as networks
import NVRC.loss_models.RankDVQA.loss as loss
import random
import numpy as np
import NVRC.loss_models.RankDVQA.data.dataset
from NVRC.loss_models.RankDVQA.utils import *
from NVRC.loss_models.RankDVQA.option import opt
...
if __name__ == '__main__':
    ...
    objectTrain = torch.utils.data.DataLoader(
        ...
        num_workers=12,
        drop_last=True,
        dataset=NVRC.loss_models.RankDVQA.data.dataset.DatasetTrain(
    ...
    objectTest = torch.utils.data.DataLoader(
        ...
        num_workers=4,
        drop_last=True,
        dataset=NVRC.loss_models.RankDVQA.data.dataset.DatasetTest(
            dataroot=get_dataset_dir(),
        )
    )
